...
1. ТОЧНОЕ СОВПАДЕНИЕ: Если клиент просит "белый" (White/Silver), НЕ предлагай Orange, Black, Blue! Цвета должны совпадать.
2. МОДЕЛИ: "17" и "17 Pro" и "17 Pro Max" — это РАЗНЫЕ модели. Если клиент просит "17" (базовый), запрещено предлагать "17 Pro" или "17 Pro Max".
3. Если характеристика не указана (например, не указан цвет или тип SIM) — верни ВСЕ варианты именно этой модели, какие есть в прайсе.
4. Если товара вообще нет в прайсе — верни пустой массив []. Не придумывай названия.
